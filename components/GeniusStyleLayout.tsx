  ...
  return (
    <div className="app-wrapper min-h-screen flex flex-col">
      ...
      <div className="flex-grow">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center mb-4">
            <Image
              ...
              width={48}
              height={48}
              className="mr-3 mt-1 hidden sm:inline-block"
              priority
            />
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent leading-tight" style={{ minHeight: '54px' }}>
        ...
        {/* Conditional Layout based on Condensed View */}
        {isCondensedView ? (
          // Condensed View: Side-by-side layout
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 condensed-grid">
            {/* Left Column - Original Lyrics */}
            ...
            <section className="glass-card p-6 h-full">
                ...
                {outputLyrics && (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={handleCopy}
                      className={`
                        inline-flex items-center px-3 py-1.5 rounded-md border-2 font-medium transition-all duration-100 text-xs
                        ${copySuccess
                          ? 'bg-green-500 text-white hover:bg-green-600 border-green-500 hover:border-green-600'
                          : 'border-purple-200 dark:border-purple-900 bg-purple-50 dark:bg-purple-950/30 hover:border-purple-400 dark:hover:border-purple-700 hover:bg-purple-100 dark:hover:bg-purple-900/50 text-purple-700 dark:text-purple-300'
                        }
                      `}
              ...
              <div className="relative">
                <div className="phonetic-text input-field min-h-[400px] p-4 rounded-lg font-medium text-gray-900 dark:text-white overflow-y-auto">
                  {outputLyrics ? (
                    <FormattedLyrics
                      lyrics={outputLyrics}
        ...
        {!isCondensedView && (
          <section className="glass-card p-6 md:p-8 mb-8 content-fade">
